...
def train_att_flow(n_epochs,
    ...
    for i in range(n_epochs):
        ...
        for batch_idx, data in enumerate(train_loader):
            ...
            rnn_out, hidden,_ = encoder(data_input) # get latent representation
...
def generate_spike_train_att_flow(encoder, flow_net, linear_transform, 
    ...
    for i in range(num_of_spike_train):
        ...
        while spike_time <=1.2:
            ...
            rnn_out, hidden, _ = encoder(window_in.float(), None)
    ...
    with torch.no_grad():
        for batch_idx, data in enumerate(val_loader):
            ...
            if smooth:
                ...
                data_input = window_spike
            rnn_out, hidden,_ = encoder(window_spike) # get latent representation
