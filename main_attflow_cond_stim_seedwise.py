...
for filename in range(14):
    yaml_filepath = f"config/070921/sparse-attflow/sparse-attflow-{filename}.yaml"
    ...
    for target in target_list:
        ...
        # for run,seed in itertools.product(range(n_runs),range(init_seed,init_seed+10)):
        seed = int(args.seed)
